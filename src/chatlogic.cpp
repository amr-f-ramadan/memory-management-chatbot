...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot _chatBot_stack("../images/chatbot.png");
    _chatBot_stack.SetChatLogicHandle(this);
    // add chatbot to graph root node
    _chatBot_stack.SetRootNode(rootNode);
    _chatBot = &_chatBot_stack;
    rootNode->MoveChatbotHere(std::move(_chatBot_stack));
}
